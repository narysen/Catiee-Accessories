...
export default function App() {
  ...
  // Clean check for hiding the shopping bag drawer on admin/cart/payment routes
  const currentPath = window.location.pathname;
  const showShoppingBag = !currentPath.includes('/admin') && !currentPath.includes('/cart') && !currentPath.includes('/payment');
